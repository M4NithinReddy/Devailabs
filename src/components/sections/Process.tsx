...
const steps = [
  {
    ...
    num: 1,
    title: 'Discovery',
    desc: 'We identify core operational needs, map architectural gaps, and define the intelligence roadmap tailored for your enterprise.',
    icon: DiscoveryIcon,
    accent: '#ffc107',
  },
  {
    ...
    num: 2,
    title: 'Audit',
    desc: 'Comprehensive data-readiness and security-posture review across your existing infrastructure and compliance landscape.',
    icon: AuditIcon,
    accent: '#ac89ff',
  },
  {
    ...
    num: 3,
    title: 'Configuration',
    desc: 'Customizing the 4 layers of our Stratified Intelligence Architecture to your specific operational scale and requirements.',
    icon: ConfigIcon,
    accent: '#00bcd4',
  },
  {
    ...
    num: 4,
    title: 'Integration',
    desc: 'Seamless API and middleware connection to your existing stack — zero downtime, full backward compatibility guaranteed.',
  ...
  },
  {
    ...
    num: 5,
    title: 'Monitoring',
    desc: 'Continuous AI-driven optimization, anomaly detection, and comprehensive performance reporting in real time.',
    icon: MonitorIcon,
    accent: '#ffc107',
  },
];
